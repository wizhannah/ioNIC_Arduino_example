...
void setup() {
  ...
  Serial.println("=== SPI Loopback Client ===");
  Serial.println("USB Serial -> SPI DATA TX, SPI DATA RX -> USB Serial");
  Serial.println("Open Serial Monitor at 115200 and type data.");
