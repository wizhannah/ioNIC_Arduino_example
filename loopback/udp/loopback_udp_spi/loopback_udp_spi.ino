...
void setup() {
  ...
  Serial.println("=== SPI Loopback UDP ===");
  Serial.println("Incoming UDP data is echoed back.");
  Serial.println("Set RH/RP to your UDP peer for echo.");
  Serial.println("");
}
